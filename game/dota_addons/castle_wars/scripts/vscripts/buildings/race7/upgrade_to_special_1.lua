...
function cast_upgrade(event)
	...
	if RemoveGold(iPlayerID, 100, 7) == true then
		local barracks = CreateUnitByName("race_7_special_building_1", vPosition, false, hero, hero, iTeamNumber)
