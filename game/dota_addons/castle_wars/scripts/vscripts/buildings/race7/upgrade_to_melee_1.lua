...
function cast_upgrade(event)
	...
	if RemoveGold(iPlayerID, 0, 7) == true then
		local barracks = CreateUnitByName("race_7_melee_building_1", vPosition, false, hero, hero, iTeamNumber)
