...
TREE_REGROW_TIME = 360.0                 -- How long should it take individual trees to respawn after being cut down/destroyed?
...
RUNE_SPAWN_TIME = 360                   -- How long in seconds should we wait between rune spawns?
...
--Specific Settings
KILLS_TO_END = 50
KILLS_TO_END_GAME_FOR_TEAM = KILLS_TO_END         -- How many kills for a team should signify an end of game?
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 245, 245, 213 }  --    Vanilla - Humans
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 220, 16, 213 }   --    DarkPurple - Outlanders
TEAM_COLORS[DOTA_TEAM_CUSTOM_1] = { 156, 115, 95 }  --    DarkBrown - Undeads
TEAM_COLORS[DOTA_TEAM_CUSTOM_2] = { 51, 153, 255 }   --    Blue - Smallfolk
TEAM_COLORS[DOTA_TEAM_CUSTOM_3] = { 82, 166, 92 }   --    DarkGreen - Guardians of Nature
TEAM_COLORS[DOTA_TEAM_CUSTOM_4] = { 101, 212, 19 }  --    Green
TEAM_COLORS[DOTA_TEAM_CUSTOM_5] = { 52, 85, 255 }   --    Blue
...
CUSTOM_TEAM_PLAYER_COUNT = {20}           -- If we're not automatically setting the number of players per team, use this table
